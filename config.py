...
class Config:
    ...
    SEGMENTATION_METRICS = ["dice_coefficient", "iou"]
    ...
    def validate_config(cls):
        ...
        assert (
            cls.TRAIN_SPLIT + cls.VAL_SPLIT + cls.TEST_SPLIT == 1.0
        ), "Data splits must sum to 1.0"

        assert (
            cls.IMAGE_SIZE[0] > 0 and cls.IMAGE_SIZE[1] > 0
